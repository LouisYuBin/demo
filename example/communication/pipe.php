...
class Pipe
{
     ...
     */
    public function __construct($filename = '/home/louis/data/github/ArrowWorker/App/Runtime/ArrowWorker.pipe', $mode = 0666, $block = false)
    {
...
function signalHandler($signal)
{
    ...
    switch($signal)
    {
        case SIGUSR1:
        	...
        	break;
        case SIGALRM:
			echo PHP_EOL.PHP_EOL."SIGALRM".PHP_EOL.PHP_EOL;
            echo "fuck";
            break;
         //$terminal = true;
         break;
...
pcntl_signal(SIGALRM,"signalHandler",false);
